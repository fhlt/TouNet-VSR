...
def get_test_set(data_dir, video_name, nFrames, upscale_factor, file_list, other_dataset, future_frame):
    return DatasetFromFolderTest(data_dir, video_name, nFrames, upscale_factor, file_list, other_dataset, future_frame, transform=transform())
