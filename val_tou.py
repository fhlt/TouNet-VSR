...
parser.add_argument('--pretrained_sr',default='4x_ubuntu-W580-G20TouNetF7_epoch_3.pth', help='sr pretrained base model')
...
def test(epoch):
    ...
    for iteration, batch in enumerate(testing_data_loader, 1):
        ...
        if cuda:
            ...
            target = Variable(target).cuda(gpus_list[gpu_no])
...
if cuda:
    ...
    criterion = criterion.cuda(gpus_list[gpu_no])
